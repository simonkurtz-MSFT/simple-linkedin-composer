...
- Run the working-tree lockfile normalizer after installs and enforce registry cleanliness through the repository check command; keep pre-commit normalization staged-only.
