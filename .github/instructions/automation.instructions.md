...
- Run repository validation for pull requests, including forks, with read-only permissions. Scope Pages write and OIDC permissions, deployment environments, and deployment concurrency to trusted push or manual deployment jobs.
