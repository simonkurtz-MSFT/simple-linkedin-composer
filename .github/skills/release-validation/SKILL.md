...
5. Test working-tree normalization and the pre-commit scrubber against absent, public, Microsoft-proxy-style, inline, block-style, staged-only, and mixed staged/unstaged tarball cases. Confirm the repository check rejects unnormalized metadata.
