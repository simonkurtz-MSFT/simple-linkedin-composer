...
(() => {
    ...
    "ops": [
        ...
        { "insert": "\\n\\nEnter your LinkedIn profile ID" }, { "attributes": { "list": "ordered" }, "insert": "\\n" },
        { "insert": "Compose your post" }, { "attributes": { "list": "ordered" }, "insert": "\\n" },
        { "insert": "Select \\"Copy post\\"" }, { "attributes": { "list": "ordered" }, "insert": "\\n" },
        { "insert": "Select \\"Open LinkedIn\\"" }, { "attributes": { "list": "ordered" }, "insert": "\\n" },
        ...
        { "attributes": { "bold": true }, "insert": "Composer content remains in local browser storage and is not included in anonymous site analytics. " }, { "attributes": { "list": "bullet" }, "insert": "\\n" },
